...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "stStationCu3", "Plc", TypeComplexityEnum.Complex)]
	public partial class stStationCu3 : Vortex.Connector.IVortexObject, IstStationCu3, IShadowstStationCu3, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineString IstStationCu3.Name
		{
			get
			{
				return Name;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowString IShadowstStationCu3.Name
		{
			get
			{
				return Name;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IstStationCu3.IsOn
		{
			get
			{
				return IsOn;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowstStationCu3.IsOn
		{
			get
			{
				return IsOn;
		...
		[Vortex.Connector.EnumeratorDiscriminatorAttribute(typeof (stTestEnum))]
		Vortex.Connector.ValueTypes.Online.IOnlineInt IstStationCu3.Cu1Enum
		{
			get
			{
				return Cu1Enum;
		...
		[Vortex.Connector.EnumeratorDiscriminatorAttribute(typeof (stTestEnum))]
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowstStationCu3.Cu1Enum
		{
			get
			{
				return Cu1Enum;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineTimeOfDay IstStationCu3.TimeOfDay
		{
			get
			{
				return TimeOfDay;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowTimeOfDay IShadowstStationCu3.TimeOfDay
		{
			get
			{
				return TimeOfDay;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineDate IstStationCu3.TestDate
		{
			get
			{
				return TestDate;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowDate IShadowstStationCu3.TestDate
		{
			get
			{
				return TestDate;
		...
		public PlainstStationCu3 CreatePlainerType()
		{
			var cloned = new PlainstStationCu3();
			return cloned;
		}

		protected PlainstStationCu3 CreatePlainerType(PlainstStationCu3 cloned)
		{
			return cloned;
		}
		...
		public void FlushPlainToOnline(Plc.PlainstStationCu3 source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc.PlainstStationCu3 source)
		{
		...
		public void FlushOnlineToPlain(Plc.PlainstStationCu3 source)
		{
			this.Read();
		...
		public stStationCu3(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
		...
		protected abstract class PlcstStationCu3
		{
			public object Name;
			public object IsOn;
            ...
            /// </summary>
            /// <exclude />
	public partial interface IstStationCu3 : Vortex.Connector.IVortexOnlineObject
	{
		...
		Plc.PlainstStationCu3 CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(Plc.PlainstStationCu3 source);
		void FlushOnlineToPlain(Plc.PlainstStationCu3 source);
	}
            ...
            /// </summary>
            /// <exclude />
	public partial interface IShadowstStationCu3 : Vortex.Connector.IVortexShadowObject
	{
		...
		void CopyPlainToShadow(Plc.PlainstStationCu3 source);
	}
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainstStationCu3 : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		System.String _Name;
		...
		public void CopyPlainToCyclic(Plc.stStationCu3 target)
		{
		...
		public void CopyPlainToCyclic(Plc.IstStationCu3 target)
		{
			this.CopyPlainToCyclic((Plc.stStationCu3)target);
		}

		public void CopyPlainToShadow(Plc.stStationCu3 target)
		{
		...
		public void CopyPlainToShadow(Plc.IShadowstStationCu3 target)
		{
			this.CopyPlainToShadow((Plc.stStationCu3)target);
		}

		public void CopyCyclicToPlain(Plc.stStationCu3 source)
		{
		...
		public void CopyCyclicToPlain(Plc.IstStationCu3 source)
		{
			this.CopyCyclicToPlain((Plc.stStationCu3)source);
		}

		public void CopyShadowToPlain(Plc.stStationCu3 source)
		{
		...
		public void CopyShadowToPlain(Plc.IShadowstStationCu3 source)
		{
			this.CopyShadowToPlain((Plc.stStationCu3)source);
		}

		public event System.ComponentModel.PropertyChangedEventHandler PropertyChanged;
		public PlainstStationCu3()
		{
		}
	}
}